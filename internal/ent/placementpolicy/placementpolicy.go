...
const (
	// Label holds the string label denoting the placementpolicy type in the database.
	Label = "placement_policy"
	...
	// Table holds the table name of the placementpolicy in the database.
	Table = "placementpolicy"
)

// Columns holds all SQL columns for placementpolicy fields.
var Columns = []string{
	FieldId,
	FieldAlias,
	FieldName,
...
var (
	// ValueScanner of all PlacementPolicy fields.
	ValueScanner struct {
		Params field.TypeValueScanner[*api.PlacementParams]
	}
)

// OrderOption defines the ordering options for the PlacementPolicy queries.

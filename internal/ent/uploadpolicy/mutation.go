...
// Mutation represents an operation that mutates the UploadPolicy nodes in the graph.
...
// NewMutation creates a new Mutation for the UploadPolicy entity.
...
func (m *Mutation) Predicates() []predicate.UploadPolicy {
	return m.predicates
}
...
func (m *Mutation) SetBounds(ab *api.UploadBounds) {
	m.bounds = &ab
}

// Bounds returns the value of the "bounds" field in the mutation.
func (m *Mutation) Bounds() (r *api.UploadBounds, exists bool) {
	v := m.bounds
	if v == nil {
		return
	}
...
func (m *Mutation) ClearBounds() {
	m.bounds = nil
	m.clearedFields[FieldBounds] = struct{}{}
}

// BoundsCleared returns if the "bounds" field was cleared in this mutation.
func (m *Mutation) BoundsCleared() bool {
	_, ok := m.clearedFields[FieldBounds]
	return ok
}

// ResetBounds resets all changes to the "bounds" field.
func (m *Mutation) ResetBounds() {
	m.bounds = nil
	delete(m.clearedFields, FieldBounds)
}
...
func (m *Mutation) Where(ps ...predicate.UploadPolicy) {
...
func (m *Mutation) WhereP(ps ...func(*sql.Selector)) {
	p := make([]predicate.UploadPolicy, len(ps))
	for i := range ps {
		p[i] = ps[i]
	}
	m.Where(p...)
...
// Type returns the node type of this mutation (UploadPolicy).
...
func (m *Mutation) SetField(name string, value ent.Value) error {
	...
	return fmt.Errorf("unknown UploadPolicy field %s", name)
}
...
func (m *Mutation) AddField(name string, value ent.Value) error {
	...
	return fmt.Errorf("unknown UploadPolicy numeric field %s", name)
}
...
func (m *Mutation) ClearField(name string) error {
	...
	return fmt.Errorf("unknown UploadPolicy nullable field %s", name)
}
...
func (m *Mutation) ClearEdge(name string) error {
	return fmt.Errorf("unknown UploadPolicy unique edge %s", name)
}

// ResetEdge resets all changes to the edge with the given name in this mutation.
// It returns an error if the edge is not defined in the schema.
func (m *Mutation) ResetEdge(name string) error {
	return fmt.Errorf("unknown UploadPolicy edge %s", name)
}

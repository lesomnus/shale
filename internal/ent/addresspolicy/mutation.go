...
// Mutation represents an operation that mutates the AddressPolicy nodes in the graph.
...
// NewMutation creates a new Mutation for the AddressPolicy entity.
...
func (m *Mutation) Predicates() []predicate.AddressPolicy {
	return m.predicates
}
...
func (m *Mutation) SetParams(ap *api.AddressParams) {
	m.params = &ap
}

// Params returns the value of the "params" field in the mutation.
func (m *Mutation) Params() (r *api.AddressParams, exists bool) {
	v := m.params
	if v == nil {
		return
	}
...
func (m *Mutation) Where(ps ...predicate.AddressPolicy) {
...
func (m *Mutation) WhereP(ps ...func(*sql.Selector)) {
	p := make([]predicate.AddressPolicy, len(ps))
	for i := range ps {
		p[i] = ps[i]
	}
	m.Where(p...)
...
// Type returns the node type of this mutation (AddressPolicy).
...
func (m *Mutation) SetField(name string, value ent.Value) error {
	...
	return fmt.Errorf("unknown AddressPolicy field %s", name)
}
...
func (m *Mutation) AddField(name string, value ent.Value) error {
	...
	return fmt.Errorf("unknown AddressPolicy numeric field %s", name)
}
...
func (m *Mutation) ClearField(name string) error {
	...
	return fmt.Errorf("unknown AddressPolicy nullable field %s", name)
}
...
func (m *Mutation) ClearEdge(name string) error {
	return fmt.Errorf("unknown AddressPolicy unique edge %s", name)
}

// ResetEdge resets all changes to the edge with the given name in this mutation.
// It returns an error if the edge is not defined in the schema.
func (m *Mutation) ResetEdge(name string) error {
	return fmt.Errorf("unknown AddressPolicy edge %s", name)
}

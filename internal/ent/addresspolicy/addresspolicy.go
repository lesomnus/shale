...
const (
	// Label holds the string label denoting the addresspolicy type in the database.
	...
	// Table holds the table name of the addresspolicy in the database.
	Table = "addresspolicy"
)

// Columns holds all SQL columns for addresspolicy fields.
var Columns = []string{
	FieldId,
	FieldAlias,
	FieldName,
...
var (
	// ValueScanner of all AddressPolicy fields.
	ValueScanner struct {
		Params field.TypeValueScanner[*api.AddressParams]
	}
)

// OrderOption defines the ordering options for the AddressPolicy queries.

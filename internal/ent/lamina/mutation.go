...
// Mutation represents an operation that mutates the Lamina nodes in the graph.
...
// NewMutation creates a new Mutation for the Lamina entity.
...
func (m *Mutation) Predicates() []predicate.Lamina {
	return m.predicates
}

// SetLaminaKey sets the "lamina_key" field.
func (m *Mutation) SetLaminaKey(s string) {
	m.lamina_key = &s
}

// LaminaKey returns the value of the "lamina_key" field in the mutation.
func (m *Mutation) LaminaKey() (r string, exists bool) {
	v := m.lamina_key
	if v == nil {
		return
	}
...
// ResetLaminaKey resets all changes to the "lamina_key" field.
func (m *Mutation) ResetLaminaKey() {
	m.lamina_key = nil
}
...
func (m *Mutation) Where(ps ...predicate.Lamina) {
...
func (m *Mutation) WhereP(ps ...func(*sql.Selector)) {
	p := make([]predicate.Lamina, len(ps))
	for i := range ps {
		p[i] = ps[i]
	}
	m.Where(p...)
...
// Type returns the node type of this mutation (Lamina).
...
func (m *Mutation) SetField(name string, value ent.Value) error {
	...
	return fmt.Errorf("unknown Lamina field %s", name)
}
...
func (m *Mutation) ClearField(name string) error {
	...
	return fmt.Errorf("unknown Lamina nullable field %s", name)
}
...
func (m *Mutation) ClearEdge(name string) error {
	...
	return fmt.Errorf("unknown Lamina unique edge %s", name)
}
...
func (m *Mutation) ResetEdge(name string) error {
	...
	return fmt.Errorf("unknown Lamina edge %s", name)
}

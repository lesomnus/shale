...
const (
	// Label holds the string label denoting the lamina type in the database.
	Label = "lamina"
	// FieldId holds the string denoting the id field in the database.
	FieldId = "id"
	// FieldLaminaKey holds the string denoting the lamina_key field in the database.
	FieldLaminaKey = "lamina_key"
	...
	EdgeSink = "sink"
	// Table holds the table name of the lamina in the database.
	Table = "lamina"
...
// Columns holds all SQL columns for lamina fields.
var Columns = []string{
	FieldId,
	FieldLaminaKey,
	FieldState,
...
// OrderOption defines the ordering options for the Lamina queries.
...
// ByLaminaKey orders the results by the lamina_key field.
func ByLaminaKey(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldLaminaKey, opts...).ToFunc()
}

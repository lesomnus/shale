...
func (_q *DeviceQuery) QueryNode() *NodeQuery {
...
func (_q *DeviceQuery) WithNode(opts ...func(*NodeQuery)) *DeviceQuery {
	query := (&NodeClient{config: _q.config}).Query()
...
func (_q *DeviceQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Device, error) {
	...
	if query := _q.withNode; query != nil {
		if err := _q.loadNode(ctx, query, nodes, nil,
			func(n *Device, e *Node) { n.Edges.Node = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *DeviceQuery) loadNode(ctx context.Context, query *NodeQuery, nodes []*Device, init func(*Device), assign func(*Device, *Node)) error {
...
func (_q *DeviceQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withNode != nil {
			_spec.Node.AddColumnOnce(device.FieldNodeId)
		}
	}

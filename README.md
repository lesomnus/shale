...
| 2 | [Data Model](docs/02-data-model.md) | §7–§10 | Tenants, sites, sources, sets, zones, and epochs; object and write-attempt state machines; node/device/sink identity; time semantics. |
...
| 6 | [Retention and GC](docs/06-retention-gc.md) | §20–§21 | `date_expired` and `date_deleted` (read like a certificate expiry), rescheduling instead of holds; watermark-driven lazy GC with node-proposed, CP-approved deletions and tenant fair share. |

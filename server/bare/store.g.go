...
type Scope interface {
	...
	NodeScope(ctx context.Context) (predicate.Node, error)
	RelayScope(ctx context.Context) (predicate.Relay, error)
	ProducerScope(ctx context.Context) (predicate.Producer, error)
	...
	PlacementPolicyScope(ctx context.Context) (predicate.PlacementPolicy, error)
	UploadPolicyScope(ctx context.Context) (predicate.UploadPolicy, error)
	AddressPolicyScope(ctx context.Context) (predicate.AddressPolicy, error)
}
...
func (Unscoped) SetScope(_ context.Context) (predicate.Set, error) {
	return nil, nil
}
func (Unscoped) SourceScope(_ context.Context) (predicate.Source, error) {
	return nil, nil
}
func (Unscoped) NodeScope(_ context.Context) (predicate.Node, error) {
	return nil, nil
}
func (Unscoped) RelayScope(_ context.Context) (predicate.Relay, error) {
	return nil, nil
}
func (Unscoped) ProducerScope(_ context.Context) (predicate.Producer, error) {
	return nil, nil
}
func (Unscoped) ReaderScope(_ context.Context) (predicate.Reader, error) {
	return nil, nil
}
func (Unscoped) DeviceScope(_ context.Context) (predicate.Device, error) {
	return nil, nil
}
...
func (Unscoped) SigningKeyScope(_ context.Context) (predicate.SigningKey, error) {
	return nil, nil
}
func (Unscoped) PlacementPolicyScope(_ context.Context) (predicate.PlacementPolicy, error) {
	return nil, nil
}
func (Unscoped) UploadPolicyScope(_ context.Context) (predicate.UploadPolicy, error) {
	return nil, nil
}
func (Unscoped) AddressPolicyScope(_ context.Context) (predicate.AddressPolicy, error) {
	return nil, nil
}
...
func (ss Scopes) SetScope(ctx context.Context) (predicate.Set, error) {
	ps := make([]predicate.Set, 0, len(ss))
	for _, s := range ss {
		p, err := s.SetScope(ctx)
		if err != nil {
			return nil, err
		}
		if p == nil {
...
func (ss Scopes) SourceScope(ctx context.Context) (predicate.Source, error) {
	ps := make([]predicate.Source, 0, len(ss))
	for _, s := range ss {
		p, err := s.SourceScope(ctx)
		if err != nil {
			return nil, err
		}
		if p == nil {
...
func (ss Scopes) NodeScope(ctx context.Context) (predicate.Node, error) {
	ps := make([]predicate.Node, 0, len(ss))
	for _, s := range ss {
		p, err := s.NodeScope(ctx)
		if err != nil {
			return nil, err
		}
		if p == nil {
...
func (ss Scopes) RelayScope(ctx context.Context) (predicate.Relay, error) {
	ps := make([]predicate.Relay, 0, len(ss))
	for _, s := range ss {
		p, err := s.RelayScope(ctx)
		if err != nil {
			return nil, err
		}
		if p == nil {
...
func (ss Scopes) ProducerScope(ctx context.Context) (predicate.Producer, error) {
	ps := make([]predicate.Producer, 0, len(ss))
	for _, s := range ss {
		p, err := s.ProducerScope(ctx)
		if err != nil {
			return nil, err
		}
		if p == nil {
...
func (ss Scopes) ReaderScope(ctx context.Context) (predicate.Reader, error) {
	ps := make([]predicate.Reader, 0, len(ss))
	for _, s := range ss {
		p, err := s.ReaderScope(ctx)
		if err != nil {
			return nil, err
		}
		if p == nil {
...
func (ss Scopes) DeviceScope(ctx context.Context) (predicate.Device, error) {
	ps := make([]predicate.Device, 0, len(ss))
	for _, s := range ss {
		p, err := s.DeviceScope(ctx)
		if err != nil {
			return nil, err
		}
		if p == nil {
...
func (ss Scopes) SinkScope(ctx context.Context) (predicate.Sink, error) {
	ps := make([]predicate.Sink, 0, len(ss))
	for _, s := range ss {
		p, err := s.SinkScope(ctx)
		if err != nil {
			return nil, err
		}
		if p == nil {
...
func (ss Scopes) SigningKeyScope(ctx context.Context) (predicate.SigningKey, error) {
	ps := make([]predicate.SigningKey, 0, len(ss))
	for _, s := range ss {
		p, err := s.SigningKeyScope(ctx)
		if err != nil {
			return nil, err
		}
		if p == nil {
...
func (ss Scopes) PlacementPolicyScope(ctx context.Context) (predicate.PlacementPolicy, error) {
	ps := make([]predicate.PlacementPolicy, 0, len(ss))
	for _, s := range ss {
		p, err := s.PlacementPolicyScope(ctx)
		if err != nil {
			return nil, err
		}
		if p == nil {
...
func (ss Scopes) UploadPolicyScope(ctx context.Context) (predicate.UploadPolicy, error) {
	ps := make([]predicate.UploadPolicy, 0, len(ss))
	for _, s := range ss {
		p, err := s.UploadPolicyScope(ctx)
		if err != nil {
			return nil, err
		}
		if p == nil {
...
func (ss Scopes) AddressPolicyScope(ctx context.Context) (predicate.AddressPolicy, error) {
	ps := make([]predicate.AddressPolicy, 0, len(ss))
	for _, s := range ss {
		p, err := s.AddressPolicyScope(ctx)
		if err != nil {
			return nil, err
		}
		if p == nil {
...
func (s Server) Node() api.NodeServiceServer         { return NodeServiceServer{Store: s.Store} }
func (s Server) Relay() api.RelayServiceServer       { return RelayServiceServer{Store: s.Store} }
func (s Server) Producer() api.ProducerServiceServer { return ProducerServiceServer{Store: s.Store} }
...
func (s Server) PlacementPolicy() api.PlacementPolicyServiceServer {
	return PlacementPolicyServiceServer{Store: s.Store}
}
func (s Server) UploadPolicy() api.UploadPolicyServiceServer {
	return UploadPolicyServiceServer{Store: s.Store}
}
func (s Server) AddressPolicy() api.AddressPolicyServiceServer {
